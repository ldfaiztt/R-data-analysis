# Count the number of different types of homicides that are in this dataset. 
# In each record there is a field with the word "Cause" in it indicating the
# cause of death (e.g. "Cause: shooting").
